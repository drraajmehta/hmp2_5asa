...
####### uniref data ############
chunk1 <- read.table("/home/rsm34/5asabb3/archive/DNA_uniref/UnirefPrecursorC1.txt", header=T, sep="\t") 
...
dim(chunk2) 
# 379036    214
write.table(chunk2, file="DNAunirefproptable_clinc_no5asa.txt", sep="\t", quote=FALSE,row.names=FALSE)
