...
mv *prausnitzii* /n/home02/rmehta/5asa/genomes/fprau/revision

cd /n/home02/rmehta/5asa/genomes/fprau/revision

find . -name "*.fna.gz" -type f -delete
find . -name "*.gbk.gz" -type f -delete
find . -name "*.cds.gz" -type f -delete
gzip -d *.gz
