...
senspec196 <- read.table("sen_spec_196_ibdmtxbb3_all.txt",header=T, sep="\t") %>% filter(metab!="binary196")
...
senspecmap[11,5]<-"A0A1C6JPG6" #rename due to uniprot switch in 8/2022
...
p3 + geom_label_repel(data = senspecmap ,aes(label=labelsraaj),box.padding = 0.1) #5X5 PDF 
